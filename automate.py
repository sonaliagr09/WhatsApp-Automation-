...
driver=webdriver.Chrome("./chromedriver.exe")   # Selenium chromedriver path
...
for name in l:
    ...
    text_box.send_keys("Hiiii, the message is sent through automation of whatsapp web using selenium in python!")
